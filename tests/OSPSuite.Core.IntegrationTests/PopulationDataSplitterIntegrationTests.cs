...
namespace OSPSuite.Core
{
   internal abstract class concern_for_PopulationDataSplitterSpecs : ContextForIntegration<PopulationDataSplitter>
   {
      ...
      private DataTable createPopAgingParameters()
      {
         ...
         var path1 = _objectPathFactory.CreateObjectPathFrom(Constants.ORGANISM,
   ...
   internal class When_filling_parameters_and_initial_values_for_the_first_individual : concern_for_PopulationDataSplitterSpecs
   {
      ...
      {
         var nonAgingPath  = _objectPathFactory.CreateObjectPathFrom(Constants.ORGANISM, ConstantsForSpecs.BW).PathAsString;
      ...
      {
         var agingPath1 = _objectPathFactory.CreateObjectPathFrom(Constants.ORGANISM, ConstantsForSpecs.TableParameter1).PathAsString;

         var agingPath2 = _objectPathFactory.CreateObjectPathFrom(Constants.ORGANISM,  ConstantsForSpecs.TableParameter2).PathAsString;
