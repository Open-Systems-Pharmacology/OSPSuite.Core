...
namespace OSPSuite.Core
{
   ...
   internal class When_running_the_case_study_for_module_integration : concern_for_ModuleIntegration
   {
      ...
      public void should_track_the_parameter_accordingly()
      {
         ...
         _simulationBuilder.ObjectSources.SourceById(parameter1.Id).SourceId.ShouldBeEqualTo(parameter1Module2.Id);
         _simulationBuilder.ObjectSources.SourceById(parameter2.Id).SourceId.ShouldBeEqualTo(parameter2Module1.Id);
         _simulationBuilder.ObjectSources.SourceById(parameter3.Id).SourceId.ShouldBeEqualTo(parameter3Module2.Id);
      }
