...
namespace OSPSuite.Presentation.Presentation
{
   ...
   public class When_grouping_all_classifications_defined_in_a_project_by_a_given_category : concern_for_ClassificationPresenter
   {
      ...
      {
         base.Context();
         var simulation1 = A.Fake<ISimulation>().WithId("1");
         _simulation1 = new ClassifiableSimulation { Subject = A.Fake<ISimulation>().WithId("1") };
         _simulation2 = new ClassifiableSimulation { Subject = A.Fake<ISimulation>().WithId("2") };
         var parentClassification = new Classification { ClassificationType = ClassificationType.Simulation };
         _simulation3WithParent = new ClassifiableSimulation { Subject = A.Fake<ISimulation>().WithId("3"), Parent = parentClassification };
         ...
         var simulationNode3 = new SimulationNode(_simulation3WithParent);
         A.CallTo(() => _explorerPresenter.NodeFor(_simulation2)).Returns(simulationNode2);
         A.CallTo(() => _explorerPresenter.NodeFor(_simulation3WithParent)).Returns(simulationNode3);
   ...
   public class When_removing_a_classification_folder_containing_classifiable_items : concern_for_ClassificationPresenter
   {
      ...
      protected override void Context()
      {
         ...
         _simulation = new ClassifiableSimulation { Parent = _childClassification, Subject = A.Fake<ISimulation>().WithId("Sim") };
   ...
   public class When_removing_a_classification_would_result_in_a_duplicate_node : concern_for_ClassificationPresenter
   {
      ...
      protected override void Context()
      {
         ...
         _simulation1 = new ClassifiableSimulation { Parent = _humanOralClassification, Subject = A.Fake<ISimulation>().WithName("S1")};
         _simulation2 = new ClassifiableSimulation { Parent = _oralClassification, Subject = A.Fake<ISimulation>().WithName("S2") };
         ...
         var simulation1Node = new SimulationNode(_simulation1).Under(_humanOralClassificationNode);
         var simulation2Node = new SimulationNode(_simulation2).Under(_oralClassificationNode);
   ...
   public class When_moving_a_classifiable_node_defined_under_a_given_classification_node_under_another_classification_node : concern_for_ClassificationPresenter
   {
      ...
      protected override void Context()
      {
         ...
         _simulation = new ClassifiableSimulation { Parent = _originalClassification, Subject = A.Fake<ISimulation>().WithName("S1") };
   ...
   public class When_removing_all_empty_classifications_from_the_classification_presenter : concern_for_ClassificationPresenter
   {
      ...
      protected override void Context()
      {
         ...
         _childClassification = new Classification { ClassificationType = ClassificationType.Simulation, Name = "child", Parent = _parentClassification };
         _simulation = new ClassifiableSimulation { Subject = A.Fake<ISimulation>() };
