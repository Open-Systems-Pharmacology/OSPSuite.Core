...
{
   public abstract class concern_for_QualificationPlanRunner : ContextSpecificationAsync<IQualificationPlanRunner>
   {
      ...
      protected override Task Context()
      {
         ...
         sut = new QualificationPlanRunner(_qualificationStepRunnerFactory, _logger);

         return _completed;
      }
   }

   public class When_running_a_qualification_plan : concern_for_QualificationPlanRunner
   {
      ...
      {
         A.CallTo(() => _logger.AddToLog(Captions.StartingQualificationPlan(_qualificationPlan.Name), LogLevel.Debug, A<string>._)).MustHaveHappened();
      }
