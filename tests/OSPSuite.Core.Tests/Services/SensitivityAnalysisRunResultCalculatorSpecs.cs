...
namespace OSPSuite.Core.Services
{
   ...
   public abstract class When_calculating_the_sensitivity_run_results : concern_for_SensitivityAnalysisRunResultCalculator
   {
      protected SensitivityAnalysisRunResult _result;
      private QuantityPKParameter _pkParameter1;
      private QuantityPKParameter _pkParameter2;
      protected SensitivityParameter _sensitivityParameter1;
      protected SensitivityParameter _sensitivityParameter2;
      private float _defaultPK1Value;
      private float _defaultPK2Value;
      ...
      {
         base.Context();
         (_defaultPK1Value, _defaultPK2Value) = GetDefaultPkValues();
         _pkParameter1 = new QuantityPKParameter { QuantityPath = "Output1", Name = "AUC" };
         _pkParameter1.SetValue(0, 10);
         _pkParameter1.SetValue(1, 11);
         _pkParameter1.SetValue(2, 12);
      ...
      protected abstract (float defaultPK1Value, float defaultPK2Value) GetDefaultPkValues();
   ...
   public class When_calculating_the_sensitivity_run_results_based_on_a_sensitivity_analysis_and_the_output_should_be_calculated : When_calculating_the_sensitivity_run_results
   {
      protected override (float defaultPK1Value, float defaultPK2Value) GetDefaultPkValues()
      {
         return (50, 70);
      }
      ...
      [Observation]
      public void state_should_indicate_successful_pk_parameter_calculation()
      {
         _result.AllPKParameterSensitivities.All(x => x.State == PKParameterSensitivityState.Success).ShouldBeTrue();
      }
   }

   public class When_calculating_the_sensitivity_run_results_based_on_a_sensitivity_analysis_and_the_pk_parameter_cannot_be_calculated : When_calculating_the_sensitivity_run_results
   {
      protected override (float defaultPK1Value, float defaultPK2Value) GetDefaultPkValues()
      {
         return (0, float.NaN);
      ...
      [Observation]
      public void state_should_indicate_failed_pk_parameter_calculation()
      {
         _result.AllPKParameterSensitivities.All(x => x.State == PKParameterSensitivityState.FailedToCalculateDefaultPKValue).ShouldBeTrue();
      }
   }
}