...
namespace OSPSuite.Core.Mappers
{
   ...
   {
      protected Domain.Classification _classification, _subClassification, _subSubClassification;
      ...
      protected override Task Context()
      {
         ...
         _classification = new Domain.Classification { ClassificationType = ClassificationType.ObservedData }.WithName("A Name");
         _subClassification = new Domain.Classification { ClassificationType = ClassificationType.ObservedData, Parent = _classification }.WithName("Sub NAme");
         _subSubClassification = new Domain.Classification { ClassificationType = ClassificationType.ObservedData, Parent = _subClassification }.WithName("Sub Sub Name");

         _context = new ClassificationContext
         {
            Classifications = new List<Domain.Classification> { _classification, _subClassification, _subSubClassification },
   ...
   {
      private Domain.Classification _result;
