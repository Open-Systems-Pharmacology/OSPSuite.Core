...
namespace OSPSuite.Core.Mappers
{
   public abstract class concern_for_OutputSelectionsMapper : ContextSpecificationAsync<OutputSelectionsMapper>
   {
      ...
      protected IEntitiesInSimulationRetriever _entitiesInContainerRetriever;
      ...
      {
         _entitiesInContainerRetriever = A.Fake<IEntitiesInSimulationRetriever>();
         _logger = A.Fake<IOSPSuiteLogger>();
         sut = new OutputSelectionsMapper(_logger, _entitiesInContainerRetriever);
   ...
   public class When_mapping_a_output_selection_snapshot_to_output_selection : concern_for_OutputSelectionsMapper
   {
      ...
      protected override async Task Because()
      {
         _newOutputSelections = await sut.MapToModel(_snapshot, new SnapshotContextWithSimulation(_simulation, new SnapshotContext(new TestProject(), SnapshotVersions.Current)));
      }
   ...
   public class When_mapping_an_output_selection_containing_an_output_that_does_not_exist_anymore : concern_for_OutputSelectionsMapper
   {
      ...
      {
         return sut.MapToModel(_snapshot, new SnapshotContextWithSimulation(_simulation, new SnapshotContext(new TestProject(), SnapshotVersions.Current)));
      }
