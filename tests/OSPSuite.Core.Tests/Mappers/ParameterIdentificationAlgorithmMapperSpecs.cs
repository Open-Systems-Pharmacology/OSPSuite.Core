...
namespace OSPSuite.Core.Mappers
{
   ...
   public class When_mapping_a_parameter_identification_algorithm_to_snapshot : concern_for_ParameterIdentificationAlgorithmMapper
   {
      ...
      [Observation]
      public void should_return_a_snapshot_having_the_expected_algorithm_properties()
      {
   ...
   public class When_mapping_a_parameter_identification_algorithm_snapshot_to_algorithm_properties : concern_for_ParameterIdentificationAlgorithmMapper
   {
      ...
      protected override async Task Because()
      {
         _newAlgorithmProperties = await sut.MapToModel(_snapshot, new SnapshotContext(new TestProject(), SnapshotVersions.Current));
      }
