...
namespace OSPSuite.Core.Mappers
{
   public abstract class concern_for_OutputSchemaMapper : ContextSpecificationAsync<OutputSchemaMapper>
   {
      ...
      protected override Task Context()
      {
         ...
         sut = new Helpers.Snapshots.OutputSchemaMapper(_outputIntervalMapper, _containerTask, _outputSchemaFactory);
   ...
   public class When_mapping_an_output_schema_to_snapshot : concern_for_OutputSchemaMapper
   {
      ...
      [Observation]
      public void should_return_a_snapshot_with_the_expected_intervals()
      {
   ...
   public class When_mapping_a_snapshot_output_schema_to_output_schema : concern_for_OutputSchemaMapper
   {
      ...
      protected override async Task Context()
      {
         ...
         A.CallTo(() => _outputSchemaFactory.CreateDefault()).Returns(outputSchema);
      ...
      protected override async Task Because()
      {
         _newOutputSchema = await sut.MapToModel(_snapshot, new SnapshotContext(new TestProject(), SnapshotVersions.Current));
      }
