...
namespace OSPSuite.Core.Mappers
{
   ...
   public class When_mapping_a_parameter_identification_configuration_snapshot_to_parameter_identification_configuration : concern_for_ParameterIdentificationConfigurationMapper
   {
      ...
      private Domain.ParameterIdentifications.ParameterIdentificationRunMode _newRunMode;
      ...
      {
         return sut.MapToModel(_snapshot, new ParameterIdentificationContext(_parameterIdentification, new SnapshotContext(new TestProject(), SnapshotVersions.Current)));
      }
