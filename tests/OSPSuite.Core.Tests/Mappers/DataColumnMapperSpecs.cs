...
namespace OSPSuite.Core.Mappers
{
   public abstract class concern_for_DataColumnMapper : ContextSpecificationAsync<DataColumnMapper>
   {
      ...
      protected ModelDataColumn _dataColumn;
      protected SnapshotDataColumn _snapshot;
      protected ModelDataColumn _relatedColumn;
      ...
      protected override Task Context()
      {
         ...
         sut = new DataColumnMapper(_dataInfoMapper, _quantityInfoMapper, _dimensionFactory);
         ...
         _relatedColumn = new ModelDataColumn("related", DomainHelperForSpecs.NoDimension(), observedData.BaseGrid)
         {
            Values = new[] { 0f, 0f, 0f },
   ...
   {
      private ModelDataColumn _result;
   ...
   public class When_mapping_snapshot_to_data_column : concern_for_DataColumnMapper
   {
      ...
      {
         _result.ShouldBeAnInstanceOf<ModelDataColumn>();
      }
