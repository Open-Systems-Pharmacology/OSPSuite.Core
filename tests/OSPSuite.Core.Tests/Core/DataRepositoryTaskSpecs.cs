...
{
   public abstract class concern_for_DataRepositoryTask : ContextSpecification<IDataRepositoryTask>
   {
   ...
   public class When_converting_a_data_repository_with_auxiliary_columns_to_datatable : concern_for_DataRepositoryTask
   {
      private DataColumn _col1;
      private DataColumn _col2;
      private DataTable _dataTable;
   ...
   public class When_converting_a_data_repository_with_an_empty_name : concern_for_DataRepositoryTask
   {
      private DataColumn _col1;
      private DataTable _dataTable;
      private IEnumerable<DataTable> _results;
   ...
   public class When_converting_a_data_repository_with_an_name_to_long : concern_for_DataRepositoryTask
   {
      private DataColumn _col1;
      private DataTable _dataTable;
      private IEnumerable<DataTable> _results;
