...
{
   public abstract class concern_for_explicit_formula_parser : ContextSpecification<IExplicitFormulaParser>
   {
      protected IParsedFunction _parsedFunction;
   ...
   public class When_setting_the_formula_string_to_the_formula_parser : concern_for_explicit_formula_parser
   {
   ...
   public class When_getting_the_formula_string : concern_for_explicit_formula_parser
   {
      private string _formulaString = "tralala";
   ...
   public class When_computing_a_valid_formula : concern_for_explicit_formula_parser
   {
   ...
   public class When_computing_an_invalid_formula : concern_for_explicit_formula_parser
   {
      protected override void Context()
      {
         base.Context();
   ...
   public class When_computing_an_valid_formula_but_with_the_wrong_number_of_arguments : concern_for_explicit_formula_parser
   {
      protected override void Context()
      {
         base.Context();
   ...
   public class When_parsing_a_valid_formula : concern_for_explicit_formula_parser
   {
      protected override void Context()
      {
         base.Context();
   ...
   public class When_parsing_an_invalid_formula : concern_for_explicit_formula_parser
   {
      protected override void Context()
      {
         base.Context();
      ...
      [Observation]
      public void should_not_throw_a_func_parser_exception()
      {
