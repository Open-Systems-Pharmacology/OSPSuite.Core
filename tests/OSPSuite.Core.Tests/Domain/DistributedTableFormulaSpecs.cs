...
namespace OSPSuite.Core.Domain
{
   ...
   public class When_adding_points_to_the_distributed_table_formula : concern_for_DistributedTableFormula
   {
      ...
      {
         base.Context();
         _meta1 = new DistributionMetaData { Mean = 1, Deviation = 2, Distribution = DistributionType.Normal };
         _meta2 = new DistributionMetaData { Mean = 3, Deviation = 4, Distribution = DistributionType.LogNormal };
      }
