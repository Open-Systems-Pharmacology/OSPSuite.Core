...
namespace OSPSuite.Assets
{
   public static class ApplicationIcons
   {
      ...
      public static readonly ApplicationIcon Neighborhood = AddNamedIcon("OSPSuite", "Neighborhood");
      public static readonly ApplicationIcon Neighbor = AddNamedIcon("OSPSuite", "Neighbor");
