...
namespace OSPSuite.Assets
{
   ...
   public static class Error
   {
      ...
      public static readonly string EmptyDataSet = "Your settings ended up in empty data sets. This could mean that for some combination of meta data values all observations are empty. Please remove the data set from your data or add at least one observation for it.";
