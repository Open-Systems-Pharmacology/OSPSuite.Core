...
namespace OSPSuite.Assets
{
   public static class ApplicationIcons
   {
      ...
      public static readonly ApplicationIcon Excel = AddNamedIcon("ObservedData", "Excel");
      ...
      public static readonly ApplicationIcon ResultsImportFromCSV = AddNamedIcon("ResultsImportFromCSV", "ResultsImportFromCSV");
      ...
      public static readonly ApplicationIcon Matlab = AddNamedIcon("Matlab", "Matlab");
      ...
      public static readonly ApplicationIcon Other = AddNamedIcon("Help", "Other");
      ...
      public static readonly ApplicationIcon JournalExportToWord = AddNamedIcon("JournalExportToWord", "JournalExportToWord");
      ...
      public static readonly ApplicationIcon Report = AddNamedIcon("Report", "Report");
