...
namespace OSPSuite.Infrastructure.Serialization
{
   ...
   public abstract class Database<TDatabase> where TDatabase : Database<TDatabase>, new()
   {
      ...
      private IConnectionProvider _connnectionProvider;
      internal static Action<TDatabase> TableConstructor;
      private string _databasePath;
      private IDbConnection _connection;
      private IDbTransaction _transaction;

      public static TDatabase Init(IConnectionProvider connnectionProvider, string databasePath, int commandTimeout = 50)
      {
         TDatabase db = new TDatabase();
         db.InitDatabase(connnectionProvider, databasePath, commandTimeout);
      ...
      internal void InitDatabase(IConnectionProvider connnectionProvider, string databasePath, int commandTimeout = 50)
      {
         _commandTimeout = commandTimeout;
         _connnectionProvider = connnectionProvider;
      ...
      {
         return _connnectionProvider.CreateConnection(_databasePath);
      }
