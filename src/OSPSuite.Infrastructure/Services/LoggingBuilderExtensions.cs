      ...
      public static ILoggingBuilder AddFile(this ILoggingBuilder builder, string logFileFullPath, LogLevel level)
      {
         ...
         builder.AddSerilog(
           new LoggerConfiguration()
             .WriteTo.File(logFileFullPath, restrictedToMinimumLevel: serilogLevel, outputTemplate: "[{Timestamp:yyyy-MM-dd HH:mm:ss.fff} {SourceContext:l} {Level:u}] {Message:l} {Exception}")
             .CreateLogger()
         );
         return builder;
      }
