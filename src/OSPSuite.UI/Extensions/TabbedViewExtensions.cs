...
namespace OSPSuite.UI.Extensions
{
   public static class TabbedViewExtensions
   {
      ...
      {
         view.PageFrom(subPresenterItem).ImageOptions.SvgImage = icon.ToSvgImage();
         view.PageFrom(subPresenterItem).ImageOptions.SvgImageSize = UIConstants.ICON_SIZE_TAB.ToDrawingSize();
      }
