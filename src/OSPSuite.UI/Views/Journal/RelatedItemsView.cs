...
namespace OSPSuite.UI.Views.Journal
{
   public partial class RelatedItemsView : BaseResizableUserControl, IRelatedItemsView
   {
      ...
      private RepositoryItem getCompareRelatedItemRepository(RelatedItem item)
      {
         ...
         repositoryCompareRelatedItem.Buttons[0].ImageOptions.SvgImage = ApplicationIcons.Comparison;
      ...
      public override void InitializeResources()
      {
         ...
         _reloadRelatedItemRepository.Buttons[0].ImageOptions.SvgImage = ApplicationIcons.Load;

         _removeRelatedItemRepository.Buttons[0].Kind = ButtonPredefines.Glyph;
         _removeRelatedItemRepository.Buttons[0].ImageOptions.SvgImage = ApplicationIcons.Delete;
