...
{
   partial class ErrorEditorView : BaseModalView
   {
      ...
      private IErrorEditorPresenter _presenter;
      public void AttachPresenter(IErrorEditorPresenter presenter)
      {
      ...
      private void InitializeComponent()
      {
         ...
         this.PerformLayout();
         this.Text = Captions.Importer.ErrorColumnEditorTitle;
      }
   }
}
