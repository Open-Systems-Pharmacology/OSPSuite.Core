...
{
   public partial class ErrorEditorView : IErrorEditorView
   {
      public ErrorEditorView()
      {
         InitializeComponent();
         ColumnsComboBox.EditValueChanged += (s, e) => _presenter.SetErrorColumn(ColumnsComboBox.EditValue.ToString());
      }
