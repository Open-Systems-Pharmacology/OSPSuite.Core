...
{
   partial class BaseModalTabbedContainerView
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         this.Caption = "BaseModalTabbedContainerView";
         this.ClientSize = new System.Drawing.Size(427, 292);
         this.Name = "BaseModalTabbedContainerView";
         this.Text = "BaseModalTabbedContainerView";
