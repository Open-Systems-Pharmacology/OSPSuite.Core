...
namespace OSPSuite.Core.Domain
{
   ...
   public class DataFactory : IDataFactory
   {
      ...
      public DataRepository CreateRepository(IModelCoreSimulation simulation, Simulation simModelSimulation, string repositoryName = null)
      {
      ...
      private DataColumn createColumn(BaseGrid xValues, IQuantity quantity, VariableValues yValues, IEnumerable<string> quantityPath, IModelCoreSimulation simulation)
      {
