...
{
   public interface IParameterStartValue : IStartValue
   {
      ...
      /// <summary>
      /// This option is only used at the moment in PKSim when cloning a simulation. The goal is to not replace the formula of a parameter
      /// changed in the simulation with constant. This parameter is temporary is should not be serialized or updated when cloning etc. 
