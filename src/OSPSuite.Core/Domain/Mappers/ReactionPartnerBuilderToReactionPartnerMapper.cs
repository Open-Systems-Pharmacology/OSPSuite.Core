...
namespace OSPSuite.Core.Domain.Mappers
{
   ...
   public class ReactionPartnerBuilderToReactionPartnerMapper : IReactionPartnerBuilderToReactionPartnerMapper
   {
      ...
      /// </param>
      /// <param name="simulationConfiguration">simulation configuration used to create model</param>
      public IReactionPartner MapFromLocal(IReactionPartnerBuilder reactionPartnerBuilder, IContainer container, SimulationConfiguration simulationConfiguration)
      {
