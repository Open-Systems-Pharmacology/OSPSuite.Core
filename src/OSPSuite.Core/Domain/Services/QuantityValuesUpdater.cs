...
namespace OSPSuite.Core.Domain.Services
{
   ...
   internal class QuantityValuesUpdater : IQuantityValuesUpdater
   {
      ...
      {
         modelConfiguration.SimulationConfiguration.ExpressionProfiles?.SelectMany<ExpressionProfileBuildingBlock, ExpressionParameter>(x => x).Each(x => updateParameterValueFromStartValue(modelConfiguration, x, getParameter));
      }
