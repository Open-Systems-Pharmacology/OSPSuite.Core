...
{
   public class ExpressionProfileBuildingBlockDiffBuilder : PathAndAndValueEntityBuildingBlockDiffBuilder<ExpressionProfileBuildingBlock, ExpressionParameter>
   {
