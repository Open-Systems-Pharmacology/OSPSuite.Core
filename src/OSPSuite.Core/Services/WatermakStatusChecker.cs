...
{
   public interface IWatermakStatusChecker
   {
      void CheckWatermarkStatus();
   }

   public class WatermakStatusChecker : IWatermakStatusChecker
   {
      private readonly IApplicationSettings _applicationSettings;
      private readonly IDialogCreator _dialogCreator;
      private readonly IApplicationConfiguration _applicationConfiguration;

      public WatermakStatusChecker(IApplicationSettings applicationSettings, IDialogCreator dialogCreator, IApplicationConfiguration applicationConfiguration)
      {
