...
namespace OSPSuite.Core.Services
{
   public interface IChartFromTemplateService
   {
      ...
      ///    how the default column name should be created. Default returns name of column if not specified
      /// </summary>
      /// <remarks>
      ...
      /// </remarks>
      void InitializeChartFromTemplate(CurveChart chart, IEnumerable<DataColumn> dataColumns, CurveChartTemplate template, Func<DataColumn, string> curveNameDefinition = null, bool warnIfNumberOfCurvesAboveThreshold = false, int warningThreshold = Constants.DEFAULT_TEMPLATE_WARNING_THRESHOLD);
   }
}