...
{
   public class ValueOriginMapper : SnapshotMapperBase<ModelValueOrigin, SnapshotValueOrigin, SnapshotContext>
   {
      ...
      public override Task<ModelValueOrigin> MapToModel(SnapshotValueOrigin snapshot, SnapshotContext snapshotContext) => 
         Task.FromException<ModelValueOrigin>(new SnapshotMapToModelNotSupportedException<ModelValueOrigin, ModelValueOrigin>());
